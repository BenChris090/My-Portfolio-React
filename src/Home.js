...
const Home = () => {
    ...
    return ( 
        <div className="home min-h-screen h-screen bg-black">
            <Navbar/>
            <div className="p-4 mt-16 items-center space-y-2 lg:justify-around lg:mx-auto lg:max-w-xl lg:mt-8">
                ...
                <ul className="flex lg:pt-2">
                    ...
                    <Link to="https://twitter.com/IceBerg_Dev"><FaTwitter className="text-2xl text-white ml-4 lg:ml-20 hover:text-cyan-500 ease-in duration-500"/></Link>
