    ...
    return ( 
        <div className="home h-screen bg-black">
            ...
            <div className="p-4 mt-16 items-center space-y-2 lg:justify-around lg:mx-auto lg:max-w-xl lg:mt-8">
                ...
                <p id="txt1" class="text-white text-justify ease-in duration-500 lg:text-xl lg:pt-4 lg:max-w-sm">I craft streamlined websites that turns complex tasks into digital ease for everyone, 
                ensuring stress-free digital solutions for groups and individuals.</p>
